  ...
  return (
    <form action={formAction} className="grid gap-6 lg:grid-cols-[1fr_360px]">
      ...
      <div className="space-y-5">
        <section className="rounded-lg border border-border bg-surface p-5">
          ...
          <input
            ...
            required
            className="mt-2 h-12 w-full rounded-lg border border-border bg-background px-3 text-lg font-black outline-none focus:border-accent"
          />
        ...
        <section className="rounded-lg border border-border bg-surface p-5">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <p className="text-xs font-semibold text-muted-foreground">
              Use Markdown para títulos, links, imagens, listas e citações.
            </p>
          </div>
          <textarea
            name="content"
            ...
            required
            rows={18}
            className="mt-4 w-full rounded-lg border border-border bg-background px-3 py-3 font-mono text-sm leading-6 outline-none focus:border-accent"
          />
        </section>
        ...
        <section className="rounded-lg border border-border bg-surface p-5">
          ...
          <div className="mt-3 rounded-lg border border-border bg-background p-4">
            <MarkdownRenderer content={content || "Escreva o conteúdo para visualizar o preview."} />
          </div>
        </section>
      </div>
      ...
      <aside className="space-y-5">
        ...
        <section className="rounded-lg border border-border bg-surface p-5">
          <h2 className="text-lg font-black">Imagem</h2>
